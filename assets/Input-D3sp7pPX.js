import{r as g,j as s}from"./index-IM9Uqm70.js";const f=g.forwardRef(({label:e,error:r,prefixIcon:t,suffixIcon:o,multiline:m=!1,onChange:a,className:x="",style:c,id:p,...n},d)=>{const l=p||`input-${e==null?void 0:e.replace(/\s+/g,"-")}`,i=`
