import{r as h,h as x}from"./index-D_IdTjbh.js";var w={exports:{}},b={},$={exports:{}},j={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var d=h,G=C;function L(e,r){return e===r&&(e!==0||1/e===1/r)||e!==e&&r!==r}var k=typeof Object.is=="function"?Object.is:L,F=G.useSyncExternalStore,U=d.useRef,W=d.useEffect,A=d.useMemo,B=d.useDebugValue;b.useSyncExternalStoreWithSelector=function(e,r,u,a,t){var n=U(null);if(n.current===null){var f={hasValue:!1,value:null};n.current=f}else f=n.current;n=A(function(){function E(o){if(!S){if(S=!0,l=o,o=a(o),t!==void 0&&f.hasValue){var c=f.value;if(t(c,o))return v=c}return v=o}if(c=v,k(l,o))return c;var y=a(o);return t!==void 0&&t(c,y)?(l=o,c):(l=o,v=y)}var S=!1,l,v,p=u===void 0?null:u;return[function(){return E(r())},p===null?void 0:function(){return E(p())}]},[r,u,a,t]);var i=F(e,n[0],n[1]);return W(function(){f.hasValue=!0,f.value=i},[i]),B(i),i};w.exports=b;var H=w.exports;const K=x(H);export{C as s,K as u,H as w};
